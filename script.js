...
var _a, _AnswerListener_NewQuestion, _AnswerListener_Result;
let score = 0;
...
class AnswerListener {
    static Questions(element, Question) {
        let GoQ = 0;
        ...
        if (document.getElementById(element) !== null) {
            if (element === "R1" && Question === 1 && element !== null) {
                ...
                True(element);
                sleep(500).then(() => {
                    __classPrivateFieldGet(AnswerListener, _a, "m", _AnswerListener_NewQuestion).call(AnswerListener, 2);
                });
                return 0;
            }
                ...
                True(element);
                sleep(500).then(() => {
                    __classPrivateFieldGet(AnswerListener, _a, "m", _AnswerListener_NewQuestion).call(AnswerListener, 3);
                });
                return 0;
            }
                ...
                True(element);
                sleep(500).then(() => {
                    __classPrivateFieldGet(AnswerListener, _a, "m", _AnswerListener_NewQuestion).call(AnswerListener, 4);
                });
                return 0;
            }
                ...
                True(element);
                sleep(500).then(() => {
                    __classPrivateFieldGet(AnswerListener, _a, "m", _AnswerListener_NewQuestion).call(AnswerListener, 5);
                });
                return 0;
            }
                ...
                True(element);
                sleep(500).then(() => {
                    __classPrivateFieldGet(AnswerListener, _a, "m", _AnswerListener_NewQuestion).call(AnswerListener, 6);
                });
                return 0;
            }
                ...
                True(element);
                sleep(500).then(() => {
                    __classPrivateFieldGet(AnswerListener, _a, "m", _AnswerListener_NewQuestion).call(AnswerListener, 7);
                });
                return 0;
            }
                ...
                True(element);
                sleep(500).then(() => {
                    __classPrivateFieldGet(AnswerListener, _a, "m", _AnswerListener_NewQuestion).call(AnswerListener, 8);
                });
                return 0;
            }
                ...
                True(element);
                sleep(500).then(() => {
                    __classPrivateFieldGet(AnswerListener, _a, "m", _AnswerListener_NewQuestion).call(AnswerListener, 9);
                });
                return 0;
            }
                ...
                True(element);
                sleep(500).then(() => {
                    __classPrivateFieldGet(AnswerListener, _a, "m", _AnswerListener_NewQuestion).call(AnswerListener, 10);
                });
                return 0;
            }
                ...
                True(element);
                sleep(500).then(() => {
                    __classPrivateFieldGet(AnswerListener, _a, "m", _AnswerListener_Result).call(AnswerListener, score);
                });
                return 0;
            }
            False(element);
            ...
            sleep(500).then(() => {
                if (Question < 10) {
                    __classPrivateFieldGet(AnswerListener, _a, "m", _AnswerListener_NewQuestion).call(AnswerListener, Question + 1);
                }
                else if (Question >= 10) {
                    __classPrivateFieldGet(AnswerListener, _a, "m", _AnswerListener_Result).call(AnswerListener, score);
                }
...
_a = AnswerListener, _AnswerListener_NewQuestion = function _AnswerListener_NewQuestion(value) {
...
}, _AnswerListener_Result = function _AnswerListener_Result(ResultScore) {
    // Put the result
    let quizz = document.getElementById('Q');
    if (quizz) {
        if (ResultScore <= 4)
